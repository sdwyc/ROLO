...
void TileLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TileLoader::initiatedRequest)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TileLoader::*_t)(QNetworkRequest );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TileLoader::receivedImage)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TileLoader::finishedLoading)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TileLoader::errorOcurred)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject TileLoader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TileLoader.data,
      qt_meta_data_TileLoader,  qt_static_metacall, nullptr, nullptr}
};
