...
public:
    ...
    ros::Publisher pubSlopeMarker;


    ros::Subscriber subCloud;
    ros::Subscriber subGPS;
    ros::Subscriber subLoop;
    ros::Subscriber subSlope;
    ...
    visualization_msgs::MarkerArray slopeFactorMarkers;
    ...
    backMapping(){
        ...
        pubSlopeMarker = nh.advertise<visualization_msgs::Marker>("slopeMarker",10);
        ...
        subSlope = nh.subscribe<cloud_msgs::slope>(slopeTopic,50,&backMapping::slopeHandler,this);
        if(useGPS){
    ...
    void slopeHandler(const cloud_msgs::slopeConstPtr& slope)
    {
        ...
        ROS_INFO("slope pose 2:%f",slope_pos(2));
        // slope_pos(0) = s
    }
...
//                             aligedGps.header.stamp.toSec() - timestamp);
    ...
    void publishFrames()
    {
        ...
        //     {
        //         sc_lio_sam::cloud_info slamInfo;
    ...
    void visualizeGlobalMapThread()
    {
        ...
        // sc_lio_sam::save_mapRequest  req;
        // sc_lio_sam::save_mapResponse res;
