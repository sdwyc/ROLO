...
def process_tum_files(tum_file1, tum_file2, output_file):
    ...
    # 创建新数据框用于存储结果
    result_data = pd.DataFrame(columns=['timestamp', 'r', 'p', 'y', 'original_row'])
...
# 指定文件路径
tum_file1_path =   r"C:\Users\16961\Desktop\SDU\reserch\ROLO\plot\data\original\Offroad2\olr.tum"#多
tum_file2_path =   r"C:\Users\16961\Desktop\SDU\reserch\ROLO\plot\data\original\Offroad2\olg.tum"
output_file_path = r"C:\Users\16961\Desktop\SDU\reserch\ROLO\plot\data\original\Offroad2\ol1.tum"
