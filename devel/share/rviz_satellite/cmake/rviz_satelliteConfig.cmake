...
if("TRUE" STREQUAL "TRUE")
  set(rviz_satellite_SOURCE_PREFIX /home/yuaqi/3D_slam/rolo/src/rviz_satellite)
  set(rviz_satellite_DEVEL_PREFIX /home/yuaqi/3D_slam/rolo/devel)
  ...
  set(rviz_satellite_INSTALL_PREFIX /home/yuaqi/3D_slam/rolo/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_satellite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yuaqi/3D_slam/rolo/src/rviz_satellite/${idir}'.  ${_report}")
    endif()
