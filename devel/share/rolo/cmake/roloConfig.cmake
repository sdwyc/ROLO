...
if(rolo_CONFIG_INCLUDED)
  return()
endif()
set(rolo_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(rolo_SOURCE_PREFIX /home/yuaqi/3D_slam/rolo/src/ROLO)
  set(rolo_DEVEL_PREFIX /home/yuaqi/3D_slam/rolo/devel)
  set(rolo_INSTALL_PREFIX "")
  set(rolo_PREFIX ${rolo_DEVEL_PREFIX})
else()
  set(rolo_SOURCE_PREFIX "")
  set(rolo_DEVEL_PREFIX "")
  set(rolo_INSTALL_PREFIX /home/yuaqi/3D_slam/rolo/install)
  set(rolo_PREFIX ${rolo_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'rolo' is deprecated")
...
set(rolo_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/yuaqi/3D_slam/rolo/devel/include;/home/yuaqi/3D_slam/rolo/src/ROLO/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(rolo_INCLUDE_DIRS "")
  set(_include_dirs "/home/yuaqi/3D_slam/rolo/devel/include;/home/yuaqi/3D_slam/rolo/src/ROLO/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'wyc <sdwyc@mail.sdu.edu.cn>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${rolo_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rolo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rolo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yuaqi/3D_slam/rolo/src/ROLO/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rolo_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND rolo_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND rolo_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT rolo_NUM_DUMMY_TARGETS)
      set(rolo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rolo::wrapped-linker-option${rolo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rolo_NUM_DUMMY_TARGETS "${rolo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rolo::wrapped-linker-option${rolo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rolo_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yuaqi/3D_slam/rolo/devel/lib;/home/yuaqi/3D_slam/rolo/devel/lib;/home/yuaqi/stone_ws/devel/lib;/home/yuaqi/catkin_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(rolo_LIBRARY_DIRS ${lib_path})
      list(APPEND rolo_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'rolo'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND rolo_LIBRARIES ${lib})
    endif()
  endif()
...
set(rolo_EXPORTED_TARGETS "rolo_generate_messages_cpp;rolo_generate_messages_eus;rolo_generate_messages_lisp;rolo_generate_messages_nodejs;rolo_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${rolo_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "std_msgs;nav_msgs;geometry_msgs;sensor_msgs;message_runtime;visualization_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 rolo_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${rolo_dep}_FOUND)
      find_package(${rolo_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rolo_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(rolo_INCLUDE_DIRS ${${rolo_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(rolo_LIBRARIES ${rolo_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${rolo_dep}_LIBRARIES})
  _list_append_deduplicate(rolo_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(rolo_LIBRARIES ${rolo_LIBRARIES})

  _list_append_unique(rolo_LIBRARY_DIRS ${${rolo_dep}_LIBRARY_DIRS})
  list(APPEND rolo_EXPORTED_TARGETS ${${rolo_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "rolo-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${rolo_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
